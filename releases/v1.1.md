...
- Added `custom` as the primary OpenAI-compatible provider name in the CLI and web app.
- Made Custom routing vendor-neutral: users provide their own OpenAI-compatible `/v1` base URL instead of relying on a bundled third-party endpoint.
